    ...
    <main className="w-screen h-screen relative">
      ...
      >
        <div className="pl-20 md:pl-40 pb-56 md:pb-20 flex flex-col gap-5 z-[10] max-w-[750px]">
          ...
          Hi! I’m Abdurahman Mohammed, a front-end developer passionate about crafting beautiful and functional websites.
          I enjoy turning design concepts into interactive user experiences.
          </p>
